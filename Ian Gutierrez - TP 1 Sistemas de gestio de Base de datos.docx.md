...
## 5. **¿Cuáles son sus características?**  
   ...
   **Codigo cerrado: El codigo es inaccesible, por lo cual los usuarios no pueden modificar el motor de la base de datos**  
     
     
     
   **Soporte:La empresa proveedora se encarga del mantenimiento, las diferentes actualizaciones y la corrección de sus errores**  
...
## 9. **¿Cuáles son sus características?**  
   ...
   **Libertad: Los usuarios pueden adaptarlo a sus necesidades y hacer versiones modificadas para despues compartirlas entre ellos**   
     
     
     
     
   **Licencia: No posee generalmente costo economico su licencia, lo cual reduce su costo de propiedad**  
     
   **Independencia: No depende del proveedor, lo cual al no depender de una sola empresa esta puede evitar el bloqueo tecnologico**  
     
   **Seguridad: La comunidad puede ver el codigo, lo que permite una deteccion mas efectiva de vulnerabilidades o recomendaciones de ideas, permitiendo un ida y vuelta de informacion constante**  
     
   **Soporte: El desarrollo al ser impulsado por una comunidad activa permite la realizacion de actualizaciones constantemente**  
...
| :---: | ----- | ----- |
| **Costo** | Tiene un mayor costo la licencia del mismo, aumentando considerablemente el costo total del producto | Generalmente no tienen costo de licencia por lo que su costo total suele ser inferior |
| **Soporte** | Hay una gran variedad a la hora de soporte tecnico de este, generando una rapidez y comodidad superior, ademas suele tener garantia de uso durante un tiempo determinado | Al no existir un soporte oficial, puede ser complicado a la hora de arreglar una falla desconocida, haciendo que un error simple pueda escalar a algo mas grave |
| **Transparencia** |  Tienen un encriptamiento y seguridad  de alto nivel, negando su publicacion y modificacion por terceros sin permiso o licencia | La seguridad en estos es menor debido a que cualquier persona puede acceder a estas, pero la comunidad genera que la gente pueda detectar errores o vulnerabilidades entre si |
| **Casos de uso** | Empresas globales y trabajos que requieren el manejo de datos sensibles y privados | Trabajos con bajos recursos o sin la necesidad de una seguridad o soporte oficial |
